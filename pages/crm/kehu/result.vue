	...
	<view class="success-page">
		<view class="success-box flex flex-direction align-center">
			...
			<view class="btn-box flex justify-between">
				<button class="cu-btn base-btn" @tap="routerTo.push('/pages/index/index')">返回报名列表</button>
				<button class="cu-btn base-btn" v-if="pay" @tap="onOrder">查看详情</button>
